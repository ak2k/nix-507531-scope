...
Generated: 2026-09-25 07:58:45 UTC
...
| Outcome | Count |
|---|---:|
| Scanner failing, verifier fails (agreement) | 100 |
...
```json
{
  "store_path": "/nix/store/0r8fwgnqldbpzd65fayyaa1d7ik2z3lc-filen-cli-0.0.36",
  "status": "ok",
  "files_compared": 1
}
```
