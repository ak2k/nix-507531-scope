...
Generated: 2026-09-19 07:57:27 UTC
...
|---|---:|---:|---:|---:|
| **1. Direct failure** (slices) | 188 | 98 | 122 | 408 |
| &emsp;↳ distinct packages | 56 | 34 | 58 | 30 |
| **3. Build-time dependent** (packages, default view) | 1 | 1 | 1 | 1 |

## Canonical examples

- **Type 1 (direct)**: `fish-4.2.1/bin/fish` at outpath `gngn7y9mn510m…` SIGKILLs on launch on Apple Silicon — the bug's highest-profile case. End-user reports in [nixpkgs#208951](https://github.com/NixOS/nixpkgs/issues/208951). This particular cached binary is referenced by neither stable pointer: `nixpkgs-25.11-darwin` advanced past it on 2026-05-05, and the `darwin` lane now tracks `nixpkgs-26.05-darwin`. It remains in `cache.nixos.org` and still SIGKILLs for anyone pinned to a pre-pivot rev — illustrating the bistability point: a clean post-pivot fish build at `s87z9chym2j5…` happens to coexist in cache, same source, opposite Hydra-worker outcome.
...
|---|---:|---:|---:|
| Channel label | nixpkgs-26.05-darwin @ 0c32f40fe3e2 (2026-09-19) | release-26.05 @ 08a8cda3b58f (2026-09-19) | nixpkgs-unstable @ a32edd765451 (2026-09-19) |
| Paths scanned | 506,043 | 480,135 | 1,177,846 |
| Mach-O slices | 740,363 | 434,812 | 726,906 |
...
|---|---:|---:|---:|---:|
| linker-signed ad-hoc, no CMS slot | 23 | 22 | 37 | 82 |
| codesign ad-hoc, empty 8 B CMS wrapper | 153 | 76 | 75 | 304 |
| ad-hoc with Entitlements + empty CMS wrapper | 5 | 0 | 0 | 5 |
| Developer-ID-signed (non-empty CMS payload) | 7 | 0 | 10 | 17 |
| **Total** | **188** | **98** | **122** | **408** |
...
|---|---|---|---|
| `avalonia-ilspy-7.2-rc` | direct | darwin | — |
| `filen-cli-0.0.36` | direct | darwin, release, unstable | — |
| `gitlab-duo-8.89.0` | direct | darwin | — |
| `gitlab-duo-9.6.0` | direct | unstable | — |
| `httptoolkit-1.26.0` | direct | darwin, release, unstable | — |
| `httptoolkit-1.27.1` | direct | darwin, release, unstable | — |
| `hunk-0.18.0` | direct | unstable | — |
| `hunk-0.19.0` | direct | unstable | — |
| `hunk-0.20.1` | direct | unstable | — |
...
| `renovate-44.79.2` | direct | darwin, unstable | — |
| `rimgo-1.4.2` | build-time transitive | darwin, release, unstable | `tailwindcss_4-4.3.1`, `tailwindcss_4-4.3.3` |
| `shogihome-1.29.0` | direct | darwin, release, unstable | — |
| `swift-5.10.1` | direct | darwin, release, unstable | — |
| `swift-5.10.1-lib` | direct | darwin, release, unstable | — |
| `tailwindcss_4-4.3.1` | direct | darwin, release | — |
| `tailwindcss_4-4.3.3` | direct | unstable | — |
| `teams-for-linux-2.11.1` | direct | darwin, release | — |
| `teams-for-linux-2.14.1` | direct | unstable | — |
| `teams-for-linux-2.15.0` | direct | unstable | — |
...
- [darwin channel report](darwin/REPORT.md) — `nixpkgs-26.05-darwin @ 0c32f40fe3e2 (2026-09-19)`
- [release channel report](release/REPORT.md) — `release-26.05 @ 08a8cda3b58f (2026-09-19)`
- [unstable channel report](unstable/REPORT.md) — `nixpkgs-unstable @ a32edd765451 (2026-09-19)`
