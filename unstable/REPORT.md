# NixOS/nixpkgs#507531 cache scan — nixpkgs-unstable @ 01fbdeef22b7 (2026-04-26)

Generated: 2026-04-26 07:31:19 UTC

## Summary

| Metric | Count |
|---|---:|
| Store paths scanned | 755,435 |
| Mach-O slices parsed | 559,325 |
| Page-hash mismatches (slices) | 116 |
...
| Type 2 — binaries linking a failing dylib | 5 |
| Type 2 — distinct packages | 3 |
...
|---|---:|---:|---:|---:|---:|---:|
| `arm64` | 219,503 | 68 | 0 | 201,778 | 17,587 | 70 |
| `arm64e` | 130 | 0 | 0 | 50 | 0 | 80 |
| `x86_64` | 224,039 | 48 | 0 | 17,851 | 205,986 | 154 |
| `i386` | 620 | 0 | 0 | 262 | 350 | 8 |
| other/legacy (10 arch codes) | 115,033 | 0 | 0 | 4 | 196 | 114,833 |

## Fat vs thin Mach-O

| Kind | Slices | Page-hash mismatch | Other sig-invalid | Clean (signed) | Unsigned |
|---|---:|---:|---:|---:|---:|
| thin | 429,358 | 32 | 0 | 207,113 | 222,033 |
| fat | 129,967 | 84 | 0 | 12,832 | 2,086 |

Unique fat binary files: 122,024 in 1,821 packages. 10 of those packages contain at least one failing fat slice.
...
| filen-cli-0.0.36 | 1 | `/nix/store/c11s5hhq6xw02sig44j3q3zdgjgi30hj-filen-cli-0.0.36` |
| filen-cli-0.0.36 | 1 | `/nix/store/g9nm6w6hhjkpvxfiraaalqr0srqp5f1m-filen-cli-0.0.36` |
...
| tailwindcss_4-4.2.3 | 1 | `/nix/store/jx6iq19sxvk6x0fwia0snjgdabngpfsv-tailwindcss_4-4.2.3` |
| tailwindcss_4-4.2.3 | 1 | `/nix/store/q48kqycpi71pqqx40zhawkq2pjbil41m-tailwindcss_4-4.2.3` |
...
| Category | Count |
|---|---:|
| `page_hash_mismatch` | 116 |
| `other_sig_invalid` | 0 |
| `clean` (signed, verified) | 219,945 |
| `unsigned` (Mach-O without LC_CODE_SIGNATURE) | 224,119 |
| `not_real_macho` (Java .class, PPC big-endian, etc.) | 115,145 |
| `scanner_error` | 0 |
...
| Metric | Count |
|---|---:|
| Binaries that link at least one failing dylib | 5 |
| Distinct packages containing such binaries | 3 |
| Failing dylibs that serve as seeds | 88 |
| Total (binary, failing-dylib) pairs | 20 |

Top failing dylibs by number of downstream binaries:

| Seed package | Downstream binaries |
|---|---:|
| `ffmpeg-headless-8.0.1-lib` | 20 |

Dependent packages (3): `ffmpegthumbnailer-2.3.0`, `gst-libav-1.26.11`, `musikcube-3.0.5`
