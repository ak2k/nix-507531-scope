# NixOS/nixpkgs#507531 cache scan — nixpkgs-unstable @ e75f25705c29 (2026-04-30)

Generated: 2026-04-30 08:10:13 UTC

## Summary

| Metric | Count |
|---|---:|
| Store paths scanned | 1,438,128 |
| Mach-O slices parsed | 1,068,746 |
| Page-hash mismatches (slices) | 240 |
| Page-hash mismatches (distinct packages) | 39 |
|   of which linker-signed (flags=0x20002) | 56 |
|   of which codesign-signed (flags=0x2) | 184 |
...
|---|---:|---:|---:|---:|---:|---:|
| `arm64` | 418,421 | 144 | 0 | 385,233 | 32,906 | 138 |
| `arm64e` | 238 | 0 | 0 | 90 | 0 | 148 |
| `x86_64` | 428,097 | 96 | 0 | 34,234 | 393,475 | 292 |
| `i386` | 1,190 | 0 | 0 | 518 | 658 | 14 |
| other/legacy (10 arch codes) | 220,800 | 0 | 0 | 8 | 358 | 220,434 |

## Fat vs thin Mach-O

| Kind | Slices | Page-hash mismatch | Other sig-invalid | Clean (signed) | Unsigned |
|---|---:|---:|---:|---:|---:|
| thin | 820,201 | 72 | 0 | 396,425 | 423,374 |
| fat | 248,545 | 168 | 0 | 23,658 | 4,023 |

Unique fat binary files: 124,035 in 2,109 packages. 10 of those packages contain at least one failing fat slice.
...
| avalonia-ilspy-7.2-rc | 18 | `/nix/store/7mhskg5xn99f3y19qrkc71swg6rm663m-avalonia-ilspy-7.2-rc` |
...
| filen-cli-0.0.36 | 3 | `/nix/store/g9nm6w6hhjkpvxfiraaalqr0srqp5f1m-filen-cli-0.0.36` |
| httptoolkit-1.24.4 | 1 | `/nix/store/1bshc8sryl7xm80jinkhrf9vpypcyzf5-httptoolkit-1.24.4` |
| httptoolkit-1.24.4 | 2 | `/nix/store/47wl1p5bsk4c54r8vbkyhn3n2nm0588s-httptoolkit-1.24.4` |
...
| libtorch-2.9.0 | 3 | `/nix/store/vla1rdlyipmbynck3vq0vr51gij4fryk-libtorch-2.9.0` |
| mmsyn7ukr-array-0.3.0.0 | 3 | `/nix/store/ffmz0x0yik7jgrw0ljlmg1n6y041fh2x-mmsyn7ukr-array-0.3.0.0` |
...
| shogihome-1.27.0 | 2 | `/nix/store/dw23a0njkwp54zv29hf2jmyhpanad8cs-shogihome-1.27.0` |
...
| swift-5.10.1 | 33 | `/nix/store/p1fpxz9l7rc91fzp0ckwrsxmizqmbvc1-swift-5.10.1` |
| swift-5.10.1 | 33 | `/nix/store/qg9vqxfpaqq8cra97dpxk7l2ry1bsrax-swift-5.10.1` |
| swift-5.10.1-lib | 21 | `/nix/store/85sw2bgkpnqnsrj324cz61hxf7r57v5i-swift-5.10.1-lib` |
| swift-5.10.1-lib | 7 | `/nix/store/hbw00ibnsqpr625mnih2hmzf8irkj0ns-swift-5.10.1-lib` |
| swift-5.10.1-lib | 21 | `/nix/store/i7j1sls91fmn5vynqryfwhn463mv3jn0-swift-5.10.1-lib` |
...
| tailwindcss_4-4.2.3 | 3 | `/nix/store/jx6iq19sxvk6x0fwia0snjgdabngpfsv-tailwindcss_4-4.2.3` |
| tailwindcss_4-4.2.3 | 3 | `/nix/store/q48kqycpi71pqqx40zhawkq2pjbil41m-tailwindcss_4-4.2.3` |
...
| vscode-extension-kilocode-Kilo-Code-7.2.20 | 3 | `/nix/store/rriv3xrcfw1pw899n7x3q34ijfd5wis3-vscode-extension-kilocode-Kilo-Code-7.2.20` |

## Slice classification

| Category | Count |
|---|---:|
| `page_hash_mismatch` | 240 |
| `other_sig_invalid` | 0 |
| `clean` (signed, verified) | 420,083 |
| `unsigned` (Mach-O without LC_CODE_SIGNATURE) | 427,397 |
| `not_real_macho` (Java .class, PPC big-endian, etc.) | 221,026 |
| `scanner_error` | 0 |
