# NixOS/nixpkgs#507531 cache scan — nixpkgs-25.11-darwin @ 8cbe20ad0f64 (2026-05-05)

Generated: 2026-05-05 07:37:57 UTC

## Summary

| Metric | Count |
|---|---:|
| Store paths scanned | 753,318 |
| Mach-O slices parsed | 1,015,277 |
| Page-hash mismatches (slices) | 294 |
| Page-hash mismatches (distinct packages) | 25 |
|   of which linker-signed (flags=0x20002) | 108 |
|   of which codesign-signed (flags=0x2) | 186 |
...
|---|---:|---:|---:|---:|---:|---:|
| `arm64` | 478,348 | 211 | 0 | 445,036 | 33,009 | 92 |
| `arm64e` | 243 | 0 | 0 | 59 | 0 | 184 |
| `x86_64` | 504,508 | 83 | 4 | 33,835 | 470,291 | 295 |
| `i386` | 735 | 0 | 0 | 488 | 237 | 10 |
| other/legacy (10 arch codes) | 31,443 | 0 | 0 | 8 | 35 | 31,400 |

## Fat vs thin Mach-O

| Kind | Slices | Page-hash mismatch | Other sig-invalid | Clean (signed) | Unsigned |
|---|---:|---:|---:|---:|---:|
| thin | 958,270 | 113 | 4 | 456,978 | 501,166 |
| fat | 57,007 | 181 | 0 | 22,448 | 2,406 |

Unique fat binary files: 10,492 in 588 packages. 6 of those packages contain at least one failing fat slice.
...
| HCL-1.9 | 4 | `/nix/store/zhla7p947b07blrc231jj21i0q67cj1r-HCL-1.9` |
...
| shogihome-1.27.1 | 1 | `/nix/store/msrawsxszj5gyf8czj5yj6mmwi6wnxqd-shogihome-1.27.1` |
...
| swift-5.10.1-lib | 35 | `/nix/store/f3qdyspn3vc661lxa11wnp03y10x8cpd-swift-5.10.1-lib` |
...
| teams-for-linux-2.8.0 | 2 | `/nix/store/yakw5wxp2iv86197s13wib2psbk967k2-teams-for-linux-2.8.0` |
...
| Category | Count |
|---|---:|
| `page_hash_mismatch` | 294 |
| `other_sig_invalid` | 4 |
| `clean` (signed, verified) | 479,426 |
| `unsigned` (Mach-O without LC_CODE_SIGNATURE) | 503,572 |
| `not_real_macho` (Java .class, PPC big-endian, etc.) | 31,981 |
| `scanner_error` | 0 |
...
| Total (binary, failing-dylib) pairs | 1059 |
