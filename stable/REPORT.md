# NixOS/nixpkgs#507531 cache scan — nixpkgs-25.11-darwin @ dff323366779 (2026-05-02)

Generated: 2026-05-02 07:56:56 UTC

## Summary

| Metric | Count |
|---|---:|
| Store paths scanned | 693,249 |
| Mach-O slices parsed | 918,362 |
| Page-hash mismatches (slices) | 264 |
| Page-hash mismatches (distinct packages) | 24 |
|   of which linker-signed (flags=0x20002) | 96 |
|   of which codesign-signed (flags=0x2) | 168 |
...
|---|---:|---:|---:|---:|---:|---:|
| `arm64` | 432,167 | 188 | 0 | 400,960 | 30,937 | 82 |
| `arm64e` | 217 | 0 | 0 | 53 | 0 | 164 |
| `x86_64` | 457,332 | 76 | 4 | 31,613 | 425,377 | 262 |
| `i386` | 655 | 0 | 0 | 437 | 208 | 10 |
| other/legacy (10 arch codes) | 27,991 | 0 | 0 | 8 | 32 | 27,951 |

## Fat vs thin Mach-O

| Kind | Slices | Page-hash mismatch | Other sig-invalid | Clean (signed) | Unsigned |
|---|---:|---:|---:|---:|---:|
| thin | 866,305 | 101 | 4 | 411,814 | 454,378 |
| fat | 52,057 | 163 | 0 | 21,257 | 2,176 |

Unique fat binary files: 10,474 in 586 packages. 6 of those packages contain at least one failing fat slice.
...
| arion-0.2.2.0 | 5 | `/nix/store/isimvgg2hxw945jhkr68rj75hj67qhqn-arion-0.2.2.0` |
...
| httptoolkit-1.24.4 | 1 | `/nix/store/43gs3pv0w9hf8mrjxzypma582yyw67wl-httptoolkit-1.24.4` |
...
| swift-5.10.1 | 44 | `/nix/store/2bgfmhdq533vvasjzrq53adjvpadwrjp-swift-5.10.1` |
...
| swift-5.10.1-lib | 28 | `/nix/store/f3qdyspn3vc661lxa11wnp03y10x8cpd-swift-5.10.1-lib` |
...
| teams-for-linux-2.8.0 | 1 | `/nix/store/yakw5wxp2iv86197s13wib2psbk967k2-teams-for-linux-2.8.0` |
...
| Category | Count |
|---|---:|
| `page_hash_mismatch` | 264 |
| `other_sig_invalid` | 4 |
| `clean` (signed, verified) | 433,071 |
| `unsigned` (Mach-O without LC_CODE_SIGNATURE) | 456,554 |
| `not_real_macho` (Java .class, PPC big-endian, etc.) | 28,469 |
| `scanner_error` | 0 |
...
| Total (binary, failing-dylib) pairs | 932 |
