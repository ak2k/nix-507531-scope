# NixOS/nixpkgs#507531 cache scan — nixpkgs-25.11-darwin @ 41a7bd591bc4 (2026-05-06)

Generated: 2026-05-06 08:07:17 UTC

## Summary

| Metric | Count |
|---|---:|
| Store paths scanned | 800,976 |
| Mach-O slices parsed | 1,074,589 |
| Page-hash mismatches (slices) | 311 |
| Page-hash mismatches (distinct packages) | 26 |
|   of which linker-signed (flags=0x20002) | 112 |
|   of which codesign-signed (flags=0x2) | 199 |
| Other signature-invalid (slices) | 4 |
| Other signature-invalid (distinct packages) | 1 |
| Type 2 — binaries linking a failing dylib | 58 |
| Type 2 — distinct packages | 38 |
...
|---|---:|---:|---:|---:|---:|---:|
| `arm64` | 506,114 | 218 | 0 | 471,069 | 34,733 | 94 |
| `arm64e` | 259 | 0 | 0 | 63 | 0 | 196 |
| `x86_64` | 535,015 | 93 | 4 | 36,688 | 497,919 | 311 |
| `i386` | 804 | 0 | 0 | 543 | 251 | 10 |
| other/legacy (10 arch codes) | 32,397 | 0 | 0 | 8 | 35 | 32,354 |

## Fat vs thin Mach-O

| Kind | Slices | Page-hash mismatch | Other sig-invalid | Clean (signed) | Unsigned |
|---|---:|---:|---:|---:|---:|
| thin | 1,014,796 | 117 | 4 | 484,238 | 530,428 |
| fat | 59,793 | 194 | 0 | 24,133 | 2,510 |

Unique fat binary files: 10,496 in 590 packages. 6 of those packages contain at least one failing fat slice.
...
| arion-0.2.2.0 | 6 | `/nix/store/isimvgg2hxw945jhkr68rj75hj67qhqn-arion-0.2.2.0` |
| avalonia-ilspy-7.2-rc | 30 | `/nix/store/47ckid3m6rwzij933sy4kiwlkcb0llbn-avalonia-ilspy-7.2-rc` |
| avalonia-ilspy-7.2-rc | 6 | `/nix/store/l4d6aspbcs27mlisx97fhp0qdij3i39z-avalonia-ilspy-7.2-rc` |
| esy-0.8.0 | 5 | `/nix/store/bc5vpiddskrdnfc04fjh6irf3p1pw4bh-esy-0.8.0` |
| esy-0.8.0 | 2 | `/nix/store/jfxcwm7wlq0i8h11qqhj4lpnzh1inn5j-esy-0.8.0` |
...
| ffmpeg-8.0-lib | 42 | `/nix/store/hn58l3pvn5iwq87p6ddp9wsw8ai9dl93-ffmpeg-8.0-lib` |
| fish-4.2.1 | 4 | `/nix/store/gngn7y9mn510mf1hkmr0l69qbpvxfbfh-fish-4.2.1` |
| HCL-1.9 | 5 | `/nix/store/zhla7p947b07blrc231jj21i0q67cj1r-HCL-1.9` |
| httptoolkit-1.24.4 | 2 | `/nix/store/43gs3pv0w9hf8mrjxzypma582yyw67wl-httptoolkit-1.24.4` |
| httptoolkit-1.24.4 | 2 | `/nix/store/g505c34pkapf2qf5i1fq7h0bkkznl8bi-httptoolkit-1.24.4` |
| libtorch-2.9.0 | 5 | `/nix/store/3hrcgmdqmhmz309fqq2rkisgzlxqh6jq-libtorch-2.9.0` |
| niv-0.2.22-bin | 1 | `/nix/store/6ns8cyqrnd4wplfzm8fpi07rkhys9xln-niv-0.2.22-bin` |
| shogihome-1.27.0 | 1 | `/nix/store/dvr98g0gmyl8vqmw31b803n6fak2b4gs-shogihome-1.27.0` |
| shogihome-1.27.0 | 3 | `/nix/store/f1spwbbqpcpx4bcdbj21rbx3psxwzc4v-shogihome-1.27.0` |
| shogihome-1.27.1 | 2 | `/nix/store/msrawsxszj5gyf8czj5yj6mmwi6wnxqd-shogihome-1.27.1` |
| swift-5.10.1 | 55 | `/nix/store/2bgfmhdq533vvasjzrq53adjvpadwrjp-swift-5.10.1` |
...
| swift-5.10.1-lib | 42 | `/nix/store/f3qdyspn3vc661lxa11wnp03y10x8cpd-swift-5.10.1-lib` |
...
| teams-for-linux-2.8.0 | 3 | `/nix/store/yakw5wxp2iv86197s13wib2psbk967k2-teams-for-linux-2.8.0` |
...
| Category | Count |
|---|---:|
| `page_hash_mismatch` | 311 |
| `other_sig_invalid` | 4 |
| `clean` (signed, verified) | 508,371 |
| `unsigned` (Mach-O without LC_CODE_SIGNATURE) | 532,938 |
| `not_real_macho` (Java .class, PPC big-endian, etc.) | 32,965 |
| `scanner_error` | 0 |
...
| Metric | Count |
|---|---:|
| Binaries that link at least one failing dylib | 58 |
| Distinct packages containing such binaries | 38 |
| Failing dylibs that serve as seeds | 51 |
| Total (binary, failing-dylib) pairs | 1168 |
