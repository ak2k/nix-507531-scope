...
DEFAULT_CHANNEL = "https://channels.nixos.org/nixpkgs-26.05-darwin"
...
def load_paths_from_file(
    ...
    `release-26.05`) drops in wherever fetch_store_paths is used.
    """
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    src.add_argument(
        ...
        "against `release-26.05#legacyPackages.aarch64-darwin`.",
    )
    p.add_argument(
        "--cache",
